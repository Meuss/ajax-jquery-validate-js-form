    ...
    <div class="container">
      ...
      <form role="form">
        <div class="form-group row">
          ...
          <input type="text" class="col-sm-8" id="name">
        </div>
        <div class="form-group row">
          <label for="email" class="col-sm-4">Email address:</label>
          <input type="email" class="col-sm-8" id="email">
        </div>
      ...
      <div class="row explanations">
        ...
        After that, once the user validates the recaptcha, send an email via ajax to the user using a php file that processes the data.
